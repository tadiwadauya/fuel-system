    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Transactions</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('created_at') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('created_at', NULL, array('id' => 'created_at', 'class' => 'form-control datepicker-here', 'data-timepicker'=>'true','data-language'=>'en', 'placeholder' => 'e.g. 2020-01-31 00:00:01', 'required')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('amount') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('amount', NULL, array('id' => 'amount', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'Amount of fuel e.g. 1080')) !!}
                                        <div class="input-group-append">

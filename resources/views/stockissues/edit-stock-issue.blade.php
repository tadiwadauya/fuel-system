    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Modifying Stock Issue {{$stockIssue->trans_code}}</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/stockissues')}}">Stock Issues</a></li>
                        <li class="breadcrumb-item active">Edit Stock Issue</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['stockissues.update', $stockIssue->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select class="custom-select form-control dynamic" name="employee" id="employee">
                                            <option value="{{$stockIssue->employee}}">{{$employee->first_name}} {{ $employee->last_name }} - {{ $employee->department }}</option>
                                            @if ($users)
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('voucher') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('voucher', $stockIssue->voucher, array('id' => 'voucher', 'class' => 'form-control', 'placeholder' => 'e.g. 619619')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('narration') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('narration', $stockIssue->narration, array('id' => 'narration', 'class' => 'form-control', 'placeholder' => 'e.g. Lockdown duties')) !!}
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select class="form-control" name="ftype" id="ftype">
                                            <option value="{{$stockIssue->ftype}}">{{ $stockIssue->ftype}}</option>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('meter_start') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('meter_start',  $stockIssue->meter_start, array('id' => 'meter_start', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'e.g. 098745632')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('meter_stop') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('meter_stop',  $stockIssue->meter_stop, array('id' => 'meter_stop', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'e.g. 087654321')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('quantity') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('quantity',  $stockIssue->quantity, array('id' => 'quantity', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'Amount in Litres e.g. 80')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('reg_num') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('reg_num',  $stockIssue->reg_num, array('id' => 'reg_num', 'class' => 'form-control', 'placeholder' => 'e.g. ACA-4029')) !!}
                                        <div class="input-group-append">

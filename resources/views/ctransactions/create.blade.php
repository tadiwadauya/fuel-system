        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'container_transactions.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('container') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <input type="text" name="container" id="container" class="form-control" placeholder="Client Container">
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('concapacity') ? ' has-error ' : '' }}">
                                {!! Form::label('concapacity', 'Container Quantity', array('class' => 'col-md-3 control-label')); !!}
                                <div class="col-md-9">
                                    <div class="input-group">
                            ...
                            {!! Form::button('Add Transaction', array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>
    ...
    <script>
        $('#client').select2({
                ...
                if(id){
                    $.ajax({
                        type:"get",
                        url:"http://192.168.1.242:8080/whelsonfuel/getClientContainer/"+id,
                        _token: _token ,

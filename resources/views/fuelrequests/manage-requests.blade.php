                                ...
                                @foreach($frequests as $frequest)
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            <a class="btn btn-sm btn-outline-info btn-rounded waves-effect waves-light" href="{{ URL::to('/frequests/preview/' . $frequest->id) }}" >
                                                Info
                                            </a>

                                            <a class="btn btn-sm btn-success" href="{{ URL::to('/frequests/approve/' . $frequest->id) }}" >
                                                Approve
                                            </a>

                                            <a class="btn btn-sm btn-danger" href="{{ URL::to('/frequests/reject/' . $frequest->id) }}" >
                                                Reject
                                            </a>
                                        </td>
                                    </tr>

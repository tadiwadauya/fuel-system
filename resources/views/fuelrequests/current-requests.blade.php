    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">{{date('F')}} {{date('Y')}} Fuel Requests</h4>
                ...
                <div class="col-md-4">
                    <div class="float-right d-none d-md-block">
                        <div>
                            <a class="btn btn-light btn-rounded" href="{{url('/frequests/create')}}" type="button">
                                <i class="mdi mdi-plus-box mr-1"></i>Create Request
                            </a>
                        </div>
                    </div>
                    &nbsp;&nbsp;
                    <div class="float-right d-none d-md-block">
                        <div>
                            <a class="btn btn-light btn-rounded" href="{{url('/frequests/deleted')}}" type="button">
                                <i class="mdi mdi-trash-can mr-1"></i>Trashed Requests
                            </a>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">{{date('F')}} {{date('Y')}} Fuel Requests </h4>

            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Create Cash Sale</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'cashsales.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                           ...
                           <div class="form-group has-feedback row {{ $errors->has('voucher') ? ' has-error ' : '' }}">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('amount') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('amount', NULL, array('id' => 'amount', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'Amount in Litres e.g. 80')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('invoice_number', NULL, array('id' => 'invoice_number', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'placeholder' => 'Invoice No.')) !!}
                                        <div class="input-group-append">

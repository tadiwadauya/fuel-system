    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Modifying Cash Sale {{$cashSale->trans_code}}</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/cashsales')}}">Cash Sales</a></li>
                        <li class="breadcrumb-item active">Edit Cash Sale</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => ['cashsales.update', $cashSale->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select class="custom-select form-control dynamic" name="employee" id="employee">
                                            <option value="{{$cashSale->employee}}">{{$employee->first_name}} {{ $employee->last_name }} - {{ $employee->department }}</option>
                                            @if ($users)
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('voucher') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('voucher', $cashSale->voucher, array('id' => 'voucher', 'class' => 'form-control', 'placeholder' => 'e.g. 619619')) !!}
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        <select class="form-control" name="ftype" id="ftype">
                                            <option value="{{$cashSale->ftype}}">{{ $cashSale->ftype}}</option>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('meter_start') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('meter_start',  $cashSale->meter_start, array('id' => 'meter_start', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'e.g. 098745632')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('meter_stop') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('meter_stop',  $cashSale->meter_stop, array('id' => 'meter_stop', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'e.g. 087654321')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('quantity') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('quantity',  $cashSale->quantity, array('id' => 'quantity', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'Amount in Litres e.g. 80')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('invoice_number') ? ' has-error ' : '' }}">
                                {!! Form::label('invoice_number', 'invoice_number', array('class' => 'col-md-3 control-label')); !!}
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('invoice_number',  $cashSale->invoice_number, array('id' => 'invoice_number', 'class' => 'form-control','pattern'=>"^\d{1,3}*(\.\d+)?$", 'value'=>"", 'data-type'=>"currency", 'placeholder' => 'Amount in Litres e.g. 80')) !!}
                                        <div class="input-group-append">
                                            <label class="input-group-text" for="invoice_number">
                                                <i class="fa fa-fw fa-gas-pump" aria-hidden="true"></i>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('reg_num') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('reg_num',  $cashSale->reg_num, array('id' => 'reg_num', 'class' => 'form-control', 'placeholder' => 'e.g. ACA-4029')) !!}
                                        <div class="input-group-append">

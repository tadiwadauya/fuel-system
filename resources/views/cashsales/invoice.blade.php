...
$userInfo = \App\Models\User::where('paynumber', $cashsale->employee )->firstOrFail();
$done_by = \App\Models\User::where('name', $cashsale->done_by)->firstOrFail();
$allocation = \App\Models\Allocation::where('paynumber', $cashsale->employee )->firstOrFail();
...
<table width="100%">
<tr>
<td width="50%" style="text-align: left;"><span style="font-weight: bold; font-size: 14pt;">Cash Sale Invoice</span><br /></td>
...
mpdf-->
<div style="text-align: right">Date: {{$cashsale->created_at}} </div>
...
<table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8">
    ...
    <tr>
        ...
        <td width="20%">Quantity (L)</td>
    </tr>
    </thead>
    <tbody>
    <!-- ITEMS HERE -->
    <tr>
        <td align="center">{{$cashsale->trans_code}}<br /></td>
        <td>Voucher Number: {{$cashsale->voucher}}<br />Fuel Type: {{$cashsale->ftype}}<br />Vehicle Reg Number: {{$cashsale->reg_num}}<br /></td>
        <td align="center">{{$cashsale->quantity}}<br /></td>
    </tr>

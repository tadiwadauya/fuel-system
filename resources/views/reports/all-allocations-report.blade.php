    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Allocation Consumption Report For All Users</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Reports</a></li>
                        <li class="breadcrumb-item active">Allocations Reports For All Users</li>
                    </ol>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(array('route' => 'allallocations.report', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            @if(isset($allocations))
                                <strong>Showing Fuel Consumption for all users</strong>
                                <br>

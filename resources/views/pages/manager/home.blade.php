        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-4">{{date('Y')}} Service Station Monthly Fuel Sales Analysis</h4>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        @elseif(auth()->user()->allocation == 'Director')
                            <div class="card-body">
                                <h5 class="header-title mb-4">My Allocation Balance</h5>
                                <div class="media">
                                    <div class="media-body text-center">
                                        <p class="text-muted mb-2">Capacity of your fuel allocation.</p>
                                        <h4>{{$currentAllocation->alloc_size}}L</h4>
                                    </div>
                                </div>
                                <hr>
                            </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        @else
                            <div class="card-body">
                                <h4 class="header-title">My Fuel Allocations Distribution</h4>
                                <p class="card-title-desc">Distribution of Fuel for {{date('F Y')}}</p>
...
@section('footer_scripts')
    ...
    <script>
        ssDiesel = {!! json_encode($serviceStationData) !!};
        var options = {
            chart: {height: 380, type: "line", zoom: {enabled: !1}, toolbar: {show: !1}},
            colors: ["#00a7e1"],
            dataLabels: {enabled: !0},
            stroke: {width: [3], curve: "straight"},
            series: [{name: "Diesel Sales", data: ssDiesel}],
            title: {text: "Fuel Station Sales", align: "left"},
    ...
    <script>
        ...
        $(function () {
            ...
            $("#my-morris-donut").length && Morris.Donut({
                ...
                colors: ["#4c87cc", "#121742"],
                data: [
                    {label: "Petrol", value: myCurrentPeturu},
                    {label: "Diesel", value: myCurrentDhiziri}
                ]
            })
        });
    </script>

                                        ...
                                        <select class="custom-select form-control dynamic" name="paynumber" id="paynumber">
                                            ...
                                            @if ($users)
                                                @foreach($users as $user)
                                                    <option value="{{ $user->paynumber }}" data-price="{{$user->id}}">{{ $user->first_name }} {{ $user->last_name }} ({{ $user->paynumber }})- {{ $user->department }} Current allocation size: {{ $user->alloc_size }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>

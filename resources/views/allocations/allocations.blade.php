    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title mb-1">Allocations</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{url('/allocations')}}">Allocations</a></li>
                    ...
                    <div class="float-right d-none d-md-block">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated">
                                <a class="dropdown-item" href="{{url('/allocations/create')}}">Create Allocation</a>
                                <a class="dropdown-item" href="{{url('/bulkallocations')}}">Allocations Bulk Create</a>
                                <a class="dropdown-item" href="{{url('/allocations/deleted')}}">Trashed Allocations</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Allocations</h4>
                                ...
                                @foreach($allocations as $allocation)
                                    <tr>
                                        ...
                                        <td style="white-space: nowrap;">
                                            {!! Form::open(array('url' => 'allocations/' . $allocation->id, 'class' => 'btn btn-sm btn-danger ', 'data-toggle' => 'tooltip', 'title' => 'Delete')) !!}

        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(['route' => ['quotations.update', $quotation->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation']) !!}

                            {!! csrf_field() !!}

                            <div class="form-group has-feedback row {{ $errors->has('quote_num') ? ' has-error ' : '' }}">
                                {!! Form::label('quote_num', 'Quote Number', ['class' => 'col-md-3 control-label']) !!}
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('quote_num', $quotation->quote_num, ['id' => 'quote_num', 'class' => 'form-control', 'placeholder' => 'e.g WHEQ31', 'readonly']) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('client') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('client', $quotation->client, ['id' => 'client', 'class' => 'form-control', 'placeholder' => 'e.g Walk-in Customer']) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('email') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::email('email', $quotation->email, ['id' => 'email', 'class' => 'form-control', 'placeholder' => 'e.g trying@email.co.zw']) !!}
                                    </div>
                                    @if ($errors->has('email'))
                                        <span class="help-block">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('email_cc') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('email_cc', $quotation->email_cc, ['id' => 'email_cc', 'class' => 'form-control', 'placeholder' => 'e.g cctester@email.co.zw']) !!}
                                    </div>
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('price') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('price', $quotation->price, ['id' => 'price', 'class' => 'form-control', 'pattern' => '^\d{1,3}*(\.\d+)?$', 'value' => '', 'data-type' => 'currency', 'placeholder' => 'e.g. 31.31']) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('quantity') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('quantity', $quotation->quantity, ['id' => 'quantity', 'class' => 'form-control', 'pattern' => '^\d{1,3}*(\.\d+)?$', 'value' => '', 'data-type' => 'currency', 'placeholder' => 'Amount in Litres e.g. 80']) !!}
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <select class="form-control" name="currency" id="currency">
                                                <option value="{{ $quotation->currency }}">{{ $quotation->currency }}
                                                </option>
                                                <option value="USD">USD</option>
                                                <option value="ZWL">ZWL</option>
                                            </select>
                                        </div>
                                        {!! Form::text('amount', $quotation->amount, ['id' => 'amount', 'class' => 'form-control', 'pattern' => '^\d{1,3}*(\.\d+)?$', 'value' => '', 'data-type' => 'currency', 'placeholder' => 'e.g. 31.31']) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('notes') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::textarea('notes', $quotation->notes, ['id' => 'notes', 'class' => 'form-control', 'rows' => '5', 'placeholder' => 'e.g. Any additional infomation, if any']) !!}
                            ...
                            {!! Form::button('Update Quotation', ['class' => 'btn btn-success margin-bottom-1 mb-1 float-right', 'type' => 'submit']) !!}
                            {!! Form::close() !!}
                        </div>
                    </div>
                </div>

            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Inactive (Empty) Containers</li>
                    </ol>
                </div>
                ...
                <div class="col-md-4">
                    <div class="float-right d-none d-md-block">
                        <div>
                            <a class="btn btn-light btn-rounded" href="{{url('/containers/create')}}" type="button">
                                <i class="mdi mdi-plus-box mr-1"></i>Create Container
                            </a>
                        </div>
                    </div>
                    &nbsp;&nbsp;
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Inactive or Empty Containers</h4>

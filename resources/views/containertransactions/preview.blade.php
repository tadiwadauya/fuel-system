            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="float-right d-none d-md-block">
                        <div>
                            <a class="btn btn-light btn-rounded" href="{{ url('/mail-invoice/'.$invoice->id) }}" type="button">
                                <i class="mdi mdi-mail mr-1"></i>Email
                            </a>

                            <a class="btn btn-light btn-rounded" href="{{ url('/invoice-pdf/'.$invoice->id) }}" target="_blank" type="button">

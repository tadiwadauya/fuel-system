...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'manadmin'          => \App\Http\Middleware\ManAdminMiddleware::class,
        'mandieadmin'          => \App\Http\Middleware\ManDieAdminMiddleware::class,
        'checkpass'          => \App\Http\Middleware\CheckPwdChangeMiddleware::class,
    ];
}
